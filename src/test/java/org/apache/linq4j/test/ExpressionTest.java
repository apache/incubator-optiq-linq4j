...
/**
 * Unit test for {@link org.apache.linq4j.expressions.Expression}
 * and subclasses.
 */
public class ExpressionTest {
  @Test public void testLambdaCallsBinaryOp() {
    ...
    assertEquals(
        "new org.apache.linq4j.function.Function1() {\n"
  ...
  @Test public void testLambdaPrimitiveTwoArgs() {
    ...
    // Print out the expression.
    String s = Expressions.toString(lambdaExpr);
    assertEquals("new org.apache.linq4j.function.Function2() {\n"
  ...
  @Test public void testWriteConstant() {
    ...
    // enum
    assertEquals(
        "org.apache.linq4j.test.ExpressionTest.MyEnum.X",
        Expressions.toString(
            Expressions.constant(MyEnum.X)));

    // array of enum
    assertEquals(
        "new org.apache.linq4j.test.ExpressionTest.MyEnum[] {\n"
        + "  org.apache.linq4j.test.ExpressionTest.MyEnum.X,\n"
        + "  org.apache.linq4j.test.ExpressionTest.MyEnum.Y}",
        Expressions.toString(
    ...
    assertEquals(
        "new org.apache.linq4j.test.Linq4jTest.Employee[] {\n"
        + "  new org.apache.linq4j.test.Linq4jTest.Employee(\n"
        + "    100,\n"
        + "    \"Fred\",\n"
        + "    10),\n"
...
*/
    ...
    assertEquals(
        ...
        + "  final int _c = 1 + 3;\n"
        + "  final int _d = 1 + 4;\n"
        + "  org.apache.linq4j.test.ExpressionTest.bar(1, _b, _c, _d, org.apache.linq4j.test.ExpressionTest.foo(_c));\n"
        + "}\n",
        Expressions.toString(expression));
    expression.accept(new Visitor());
  }
  ...
  @Test public void testConstantExpression() {
    ...
    assertEquals(
        ...
        + "    \"string\",\n"
        + "    null},\n"
        + "  new org.apache.linq4j.test.ExpressionTest.AllType(\n"
        + "    true,\n"
        + "    (byte)100,\n"
        + "    (char)101,\n"
        + "    (short)102,\n"
