...
*/
package org.apache.linq4j.test;
...
import static org.apache.linq4j.test.BlockBuilderBase.*;
  ...
  @Test public void testDeterministicMethodCall() {
    assertThat(
        ...
        equalTo(
            ...
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return $L4J$C$org_apache_linq4j_test_DeterministicTest_TestClass_deterministi32e76142;\n"
            + "      }\n"
            + "\n"
            + "      static final int $L4J$C$org_apache_linq4j_test_DeterministicTest_TestClass_deterministi32e76142 = org.apache.linq4j.test.DeterministicTest.TestClass.deterministic(1);\n"
            + "    };\n"
            + "}\n"));
  }
  ...
  @Test public void testNonDeterministicMethodCall() {
    assertThat(
        ...
        equalTo(
            ...
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return org.apache.linq4j.test.DeterministicTest.TestClass.nonDeterministic(1);\n"
            + "      }\n"
            + "\n"
            + "    };\n"
            + "}\n"));
  ...
  @Test public void testDeterministicClassDefaultMethod() {
    assertThat(
        ...
        equalTo(
            ...
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return $L4J$C$org_apache_linq4j_test_DeterministicTest_TestDeterministicClass28c48c74;\n"
            + "      }\n"
            + "\n"
            + "      static final int $L4J$C$org_apache_linq4j_test_DeterministicTest_TestDeterministicClass28c48c74 = org.apache.linq4j.test.DeterministicTest.TestDeterministicClass.deterministic(1);\n"
            + "    };\n"
            + "}\n"));
  }
  ...
  @Test public void testDeterministicClassNonDeterministicMethod() {
    assertThat(
        ...
        equalTo(
            ...
            + "  return new Runnable(){\n"
            + "      int test() {\n"
            + "        return org.apache.linq4j.test.DeterministicTest.TestDeterministicClass.nonDeterministic(1);\n"
            + "      }\n"
            + "\n"
            + "    };\n"
            + "}\n"));
