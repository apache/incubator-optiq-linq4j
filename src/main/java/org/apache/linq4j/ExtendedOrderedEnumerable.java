...
public interface ExtendedOrderedEnumerable<T> extends Enumerable<T> {
   ...
   * {@link #thenBy(org.apache.linq4j.function.Function1, java.util.Comparator) thenBy}
   * or {@link #thenByDescending(org.apache.linq4j.function.Function1, java.util.Comparator) thenByDescending},
