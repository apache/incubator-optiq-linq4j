...
interface ExtendedQueryable<TSource> extends ExtendedEnumerable<TSource> {
   ...
   * {@link #groupBy(org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.expressions.FunctionExpression)},
   ...
   * {@link org.apache.linq4j.expressions.MethodCallExpression} that represents
   ...
   * {@link #select(org.apache.linq4j.expressions.FunctionExpression)}.</p>
   */
   ...
   * {@link #selectMany(org.apache.linq4j.expressions.FunctionExpression)}</p>
   */
   ...
   *
   * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
   * {@link #selectMany(org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.expressions.FunctionExpression)}</p>
   */
