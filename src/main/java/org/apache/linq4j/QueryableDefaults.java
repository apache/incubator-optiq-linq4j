...
public abstract class QueryableDefaults {
   ...
   * {@link #groupBy(org.apache.linq4j.Queryable, org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.expressions.FunctionExpression)},
   ...
   *
   * <p>NOTE: Renamed from {@code groupBy} to distinguish from
   * {@link #groupBy(org.apache.linq4j.Queryable, org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.function.EqualityComparer)},
   * which has the same erasure.</p>
   */
   ...
   * {@link org.apache.linq4j.expressions.MethodCallExpression} that
   * represents calling {@code ofType} itself as a constructed generic method.
   * It then passes the {@code MethodCallExpression} to the
   * {@link org.apache.linq4j.QueryProvider#createQuery createQuery} method of the
   * {@link org.apache.linq4j.QueryProvider} represented by the Provider property of the source
   * parameter.</p>
   *
   ...
   * {@link #select(org.apache.linq4j.Queryable, org.apache.linq4j.expressions.FunctionExpression)}.</p>
   */
   ...
   * {@link #selectMany(org.apache.linq4j.Queryable, org.apache.linq4j.expressions.FunctionExpression)}</p>
   */
   ...
   *
   * <p>NOTE: Renamed from {@code selectMany} because had same erasure as
   * {@link #selectMany(org.apache.linq4j.Queryable, org.apache.linq4j.expressions.FunctionExpression, org.apache.linq4j.expressions.FunctionExpression)}</p>
   */
